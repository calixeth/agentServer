...
V_THINK_PROMPT = """\
The character’s mouth does not speak or make any movements. The background remains pure black throughout. width: 1024px, height: 1536px, When suddenly asked a difficult question, the character performs a thinking gesture, pauses briefly, and then gives the answer.nagative:blur, distort, and low quality,Facial distortion
"""

V_DEFAULT_PROMPT = """\
The character looks straight ahead, maintaining a slight, reserved smile, with a pure black background behind them. width: 1024px, height: 1536px, nagative:blur, distort, and low quality,Facial distortion
"""

...
Generate a 3D cartoon Pixar-style exaggerated character (full-body portrait) based on the provided image, Medium shot, not close-up,both funny and romantic, with sparkling eyes, creating a playful and humorous atmosphere. Highly detailed, clean sharp line art, vibrant colors. Full-body standing portrait, width: 1024px, height: 1536px, front-facing, looking at camera. The entire head and hair must be fully visible inside the frame, with generous space above the head to avoid cutting. Composition should be symmetrical and centered. Clear details preserved: original facial features, hairstyle, expression, body proportions, and clothing. occupying about 70% of the frame height, leaving 30% background space visible. Ensure the subject does not dominate the entire image,Pure black background, no borders, no text.
"""
